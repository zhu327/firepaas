...
func (c *fabricServiceClient) ApplyFabric(
	ctx context.Context,
	in *ApplyFabricRequest,
	opts ...grpc.CallOption,
) (*ApplyFabricResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedFabricServiceServer) ApplyFabric(
	context.Context,
	*ApplyFabricRequest,
) (*ApplyFabricResponse, error) {
...
func _FabricService_ApplyFabric_Handler(
	srv interface{},
	ctx context.Context,
	dec func(interface{}) error,
	interceptor grpc.UnaryServerInterceptor,
