...
func TestReservedChecker(t *testing.T) {
	...
	reserved := []string{
		...
		// netpolicy canonical 集补齐（此前自维护清单缺失）：NAT64/DNS64、
		// 6to4 relay anycast、240/4、IETF 保留段。
		"64:ff9b::a00:1", "64:ff9b:1::1", "240.0.0.1", "192.88.99.1",
		"192.31.196.1", "192.52.193.1", "192.175.48.1", "3fff::1", "100::1",
