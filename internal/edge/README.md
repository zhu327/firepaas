...
```
cmd/edge-proxy/          # 入口
internal/edge/router/    # hostname -> machine 路由解析
internal/edge/catalog/   # Redis routing catalog 客户端(带 execution_id CAS)
internal/edge/autoresume/# paused machine 的自动唤醒(gRPC ResumeMachine)
